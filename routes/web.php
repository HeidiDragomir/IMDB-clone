...
Route::patch("/admin/dashboard/users/{user}", [AdminUserController::class,"update",])->middleware("admin");
Route::get("/admin/dashboard/users/{user}", [AdminUserController::class,"update",])->middleware("admin");
Route::delete("/admin/dashboard/users/{user}", [AdminUserController::class,"destroy",])->middleware("admin");


// Admin Actors
Route::get("/admin/dashboard/actors", [AdminActorController::class,"index",])->middleware("admin");
Route::post("/admin/dashboard/actors", [AdminActorController::class,"store",])->middleware("admin");
Route::get("/admin/dashboard/actors/create", [AdminActorController::class,"create",])->middleware("admin");
Route::get("/admin/dashboard/actors/{actor}/edit", [AdminActorController::class,"edit",])->middleware("admin");
Route::patch("/admin/dashboard/actors/{actor}", [AdminActorController::class,"update",])->middleware("admin");
Route::get("/admin/dashboard/actors/{actor}", [AdminActorController::class,"update",])->middleware("admin");
Route::delete("/admin/dashboard/actors/{actor}", [AdminActorController::class,"destroy",])->middleware("admin");


// Admin actor movie connection
Route::get("/admin/dashboard/createconnection", [AdminActorMovieController::class,"index",])->middleware("admin");
Route::post("/admin/dashboard/createconnection", [AdminActorMovieController::class,"store",])->middleware("admin");
